      ...
      <div class="col-md-6">
         <figure class="movie-poster">
            <div class="poster-wrapper">
               <img src="posters/Movies/captainmarvel.jpg" alt="captain marvel Poster">
            </div>
         </figure>
      </div>
      <div class="col-md-6">
         ...
         <div class="movie-summary">
            <p>
               ...
               During a mission to rescue an undercover operative infiltrating a group of Skrulls, alien shapeshifters with whom 
               the Kree are at war, Vers is captured by Skrull commander Talos. A probe of Vers' memories leads them to Earth.
               Vers escapes and crash-lands in Los Angeles. Her presence attracts S.H.I.E.L.D. agents Nick Fury and Phil Coulson,
               whose investigation is interrupted by a Skrull attack. Vers recovers a crystal containing her extracted memories in
               the ensuing chase while Fury kills a Skrull impersonating Coulson.                
            </p>
            <ul class="movie-meta">
               <li><strong>Director:</strong>Anna Boden, Ryan Fleck</li>
               <li><strong>Length:</strong> 124 min</li>
               <li><strong>Premiere:</strong> 27, Feburary 2019 (USA)</li>
