      ...
      <div class="col-md-6">
         <figure class="movie-poster">
            <div class="poster-wrapper">
               <img src="posters/Movies/thorragnarok_.jpg" alt="THOR 3 Poster">
            </div>
         </figure>
      </div>
      <div class="col-md-6">
         <h2 class="movie-title">Thor Ragnarok</h2>
         <div class="movie-summary">
            ...
            <ul class="movie-meta">
               ...
               <li><strong>Length:</strong> 130 min</li>
               <li><strong>Premiere:</strong> 3, November 2017 (USA)</li>
