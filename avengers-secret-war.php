         ...
         <div class="col-md-6">
            <figure class="movie-poster">
               <div class="poster-wrapper">
                  <img src="posters/Movies/avengerssecretwars.jpg" alt="Secret War Poster">
               </div>
            </figure>
         </div>
         <div class="col-md-6">
            <h2 class="movie-title">Avengers Secret War</h2>
            <div class="movie-summary">
               <p>
                  Marvel Studios' 'Avengers: Secret War' will be released on May 7, 2027.
               </p>
            </div>
            <ul class="movie-meta">
               <li><strong>Director:</strong>Anthony Russo, Joe Russo</li>
               <li><strong>Length:</strong> NA</li>
               <li><strong>Premiere:</strong>07, May, 2027</li>
