         ...
         <div class="col-md-6">
            <figure class="movie-poster">
               <div class="poster-wrapper">
                  <img src="posters/Movies/thefantasticfourfirststep.jpg" alt="fantastic four 3 Poster">
               </div>
            </figure>
         </div>
         <div class="col-md-6">
            <h2 class="movie-title">The Fantastic Four: First Steps</h2>
            ...
            <ul class="movie-meta">
               <li><strong>Director:</strong>Matt Shakman</li>
               <li><strong>Length:</strong> NA</li>
               <li><strong>Premiere:</strong> 25, July 2025 (USA)</li>
