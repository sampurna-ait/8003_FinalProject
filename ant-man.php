         ...
         <div class="col-md-6">
            <figure class="movie-poster">
               <div class="poster-wrapper">
                  <img src="posters/Movies/ant-man.jpg" alt="Antman Poster">
               </div>
            </figure>
         </div>
         <div class="col-md-6">
            <h2 class="movie-title">Ant Man</h2>
            <div class="movie-summary">
               <p>
                  The next evolution of the Marvel Cinematic Universe brings a founding member of The 
                  Avengers to the big screen for the first time with Marvel Studios' "Ant-Man." Armed with the astonishing ability to 
                  shrink in scale but increase in strength, master thief Scott Lang must embrace his inner-hero and help his mentor, Doctor Hank Pym, protect the secret behind his spectacular Ant-Man suit from a new generation of towering threats. Against seemingly insurmountable obstacles,
            ...
            <ul class="movie-meta">
               ...
               <li><strong>Premiere:</strong> 17, July 2015 (USA)</li>
