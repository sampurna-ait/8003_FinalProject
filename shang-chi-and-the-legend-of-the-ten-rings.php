         ...
         <div class="col-md-6">
            <figure class="movie-poster">
               <div class="poster-wrapper">
                  <img src="posters/Movies/shangchi.jpg" alt="Shang Chi Poster">
               </div>
            </figure>
         </div>
         <div class="col-md-6">
            <h2 class="movie-title">Shang Chi and The Legend of Ten Rings</h2>
            ...
            <ul class="movie-meta">
               <li><strong>Director:</strong>Destin Daniel Cretton</li>
               <li><strong>Length:</strong> 132 min</li>
               <li><strong>Premiere:</strong> 16, August 2021 (USA)</li>
