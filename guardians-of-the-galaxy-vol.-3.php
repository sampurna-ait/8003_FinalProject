         ...
         <div class="col-md-6">
            <figure class="movie-poster">
               <div class="poster-wrapper">
                  <img src="posters/Movies/guardians3.jpg" alt="Guardians 3 Poster">
               </div>
            </figure>
         </div>
         <div class="col-md-6">
            <h2 class="movie-title">Guardians Of The Galaxy Volume 3</h2>
            <div class="movie-summary">
               <p>
                  In Marvel Studios "Guardians of the Galaxy Vol. 3" our beloved 
                  band of misfits are looking a bit different these days. Peter Quill, 
                  still reeling from the loss of Gamora, must rally his team around him to
                  defend the universe along with protecting one of their own. A mission that, if not completed successfully, 
                  could quite possibly lead to the end of the Guardians as we know them
               </p>
            </div>
            <ul class="movie-meta">
               <li><strong>Director:</strong>James Gunn</li>
               <li><strong>Length:</strong> 150 min</li>
               <li><strong>Premiere:</strong> 22, April 2023 (USA)</li>
