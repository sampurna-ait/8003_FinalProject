         ...
         <div class="col-md-6">
            <figure class="movie-poster">
               <div class="poster-wrapper">
                  <img src="posters/Movies/doctorstrange.jpg" alt="Doctor Strange Poster">
               </div>
            </figure>
         </div>
         <div class="col-md-6">
            <h2 class="movie-title">Doctor Stranger</h2>
            ...
            <ul class="movie-meta">
               <li><strong>Director:</strong>Scott Derrickson</li>
               <li><strong>Length:</strong> 115 min</li>
               <li><strong>Premiere:</strong> 4, November 2016 (USA)</li>
