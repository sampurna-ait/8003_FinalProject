         ...
         <div class="col-md-6">
            <figure class="movie-poster">
               <div class="poster-wrapper">
                  <img src="posters/Movies/spider-man.jpg" alt="Spiderman Homecomming Poster">
               </div>
            </figure>
         </div>
         <div class="col-md-6">
            <h2 class="movie-title">Spiderman Homecomming</h2>
            ...
            <ul class="movie-meta">
               <li><strong>Director:</strong>John Watts</li>
               <li><strong>Length:</strong> 133 min</li>
               <li><strong>Premiere:</strong> 7, July 2017 (USA)</li>
