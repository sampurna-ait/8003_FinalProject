         ...
         <div class="col-md-6">
            <figure class="movie-poster">
               <div class="poster-wrapper">
                  <img src="posters/Movies/avengersdoomsday.jpg" alt="Doomsday Poster">
               </div>
            </figure>
         </div>
         <div class="col-md-6">
            <h2 class="movie-title">Avengers Doomsday</h2>
            <div class="movie-summary">
               <p>
                  Marvel Studios' 'Avengers: Doomsday' will be released on May 1, 2026
               </p>
            </div>
            <ul class="movie-meta">
               <li><strong>Director:</strong>Anthony Russo, Joe Russo</li>
               <li><strong>Length:</strong> NA</li>
               <li><strong>Premiere:</strong>01, May, 2026</li>
