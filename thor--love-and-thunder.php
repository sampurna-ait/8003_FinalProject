         ...
         <div class="col-md-6">
            <figure class="movie-poster">
               <div class="poster-wrapper">
                  <img src="posters/Movies/thor2.jpg" alt="Thor 2 Poster">
               </div>
            </figure>
         </div>
         <div class="col-md-6">
            ...
            <ul class="movie-meta">
               <li><strong>Director:</strong>Taika Waititi</li>
               <li><strong>Length:</strong> 119 min</li>
               <li><strong>Premiere:</strong> 8, July 2022 (USA)</li>
