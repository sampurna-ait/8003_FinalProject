      ...
      <div class="col-md-6">
         <figure class="movie-poster">
            <div class="poster-wrapper">
               <img src="posters/Movies/avengersendgame.jpg" alt="avengers 4 Poster">
            </div>
         </figure>
      </div>
      <div class="col-md-6">
         ...
         <div class="movie-summary">
            <p>
               The grave course of events set in motion by Thanos that wiped out half the universe and fractured the Avengers ranks co
               mpels the remaining Avengers to take one final stand in Marvel Studios' grand conclusion to twenty-two films,
               "Avengers: Endgame." 
            </p>
            <ul class="movie-meta">
               <li><strong>Director:</strong>Anthony Russo, Joe Russo</li>
               <li><strong>Length:</strong> 181 min</li>
               <li><strong>Premiere:</strong> 26, April 2019 (USA)</li>
