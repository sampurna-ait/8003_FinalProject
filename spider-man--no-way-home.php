         ...
         <div class="col-md-6">
            <figure class="movie-poster">
               <div class="poster-wrapper">
                  <img src="posters/Movies/spider-mannowayhome.jpg" alt="Spiderman No Way Hom Poster">
               </div>
            </figure>
         </div>
         <div class="col-md-6">
            <h2 class="movie-title">Spiderman No Way Home</h2>
            <div class="movie-summary">
               <p>
                  After Quentin Beck frames Peter Parker for his murder and reveals 
                  that Peter is Spider-Man,[a] the Department of Damage Control interrogates Peter; 
                  his girlfriend, Michelle "MJ" Jones-Watson; his best friend, Ned Leeds; and his aunt, May Parker. 
                  Lawyer Matt Murdock gets Peter's charges dropped, but the group grapples with negative publicity.
                  After Peter's, MJ's, and Ned's MIT applications are rejected, Peter goes to the New York Sanctum to
                  ask Dr. Stephen Strange for help. Strange starts casting a spell that would make everyone forget 
                  Peter is Spider-Man, but it is corrupted when Peter repeatedly requests alterations
                  to let his loved ones retain their memories. Strange contains the corrupted spell.
               </p>
            </div>
            <ul class="movie-meta">
               <li><strong>Director:</strong>Jon Watts</li>
               <li><strong>Length:</strong> 148 min</li>
               <li><strong>Premiere:</strong> 17, December 2021 (USA)</li>
               <li><strong>Category:</strong> Phase 4</li>
            </ul>
