         ...
         <div class="col-md-6">
            <figure class="movie-poster">
               <div class="poster-wrapper">
                  <img src="posters/Movies/captainamericabravenewworld.jpg" alt="america 3 Poster">
               </div>
            </figure>
         </div>
         <div class="col-md-6">
            <h2 class="movie-title">Captain America Brave New World</h2>
            <div class="movie-summary">
               <p>
                  Anthony Mackie returns as the high-flying hero Sam Wilson, who’s officially taken 
                  up the mantle of Captain America. After meeting with newly elected U.S. President Thaddeus
                  Ross, Sam finds himself in the middle of an international incident. He must discover the reason behind 
                  a nefarious global plot before the true mastermind has the entire world seeing red
               </p>
            </div>
            <ul class="movie-meta">
               <li><strong>Director:</strong>Juluis Onah</li>
               <li><strong>Length:</strong> NA</li>
               <li><strong>Premiere:</strong> 14, Feburary 2025 (USA)</li>
