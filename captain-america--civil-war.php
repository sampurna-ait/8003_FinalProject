         ...
         <div class="col-md-6">
            <figure class="movie-poster">
               <div class="poster-wrapper">
                  <img src="posters/Movies/captainamerica3.jpg" alt="Captain America Civil War Poster">
               </div>
            </figure>
         </div>
         <div class="col-md-6">
            ...
            <ul class="movie-meta">
               ...
               <li><strong>Length:</strong> 147 min</li>
               <li><strong>Premiere:</strong> 6, May 2016 (USA)</li>
