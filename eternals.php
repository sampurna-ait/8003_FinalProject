         ...
         <div class="col-md-6">
            <figure class="movie-poster">
               <div class="poster-wrapper">
                  <img src="posters/Movies/eternals.jpg" alt="Eternals Poster">
               </div>
            </figure>
         </div>
         <div class="col-md-6">
            ...
            <div class="movie-summary">
               <p>
                  Marvel Studios' Eternals features an exciting new team of Super Heroes in the Marvel Cinematic Universe, ancient 
                  aliens who have been living on Earth in secret for thousands of years. Following the events of Avengers: Endgame, 
                  an unexpected tragedy forces them out of the shadows to reunite against mankind's most ancient enemy, the Deviants.
               </p>
            </div>
            <ul class="movie-meta">
               <li><strong>Director:</strong>Chloe Zhao</li>
               <li><strong>Length:</strong> 156 min</li>
               <li><strong>Premiere:</strong> 5, November 2021 (USA)</li>
