         ...
         <div class="col-md-6">
            <figure class="movie-poster">
               <div class="poster-wrapper">
                  <img src="posters/Movies/antman3.jpg" alt="Antman 3 Poster">
               </div>
            </figure>
         </div>
         <div class="col-md-6">
            <h2 class="movie-title">Ant Man and The Wasp: Quantumania</h2>
            <div class="movie-summary">
               <p>
                  In the film, which officially kicks off phase 5 of the Marvel Cinematic
                  Universe, Super-Hero partners Scott Lang and Hope Van Dyne return to continue their adventures as Ant-Man and the Wasp. Together, with Hope's parents Hank Pym and Janet Van Dyne, the family finds themselves exploring the Quantum Realm, interacting with strange new creatures and embarking on an adventure that will push 
                  them beyond the limits of what they thought was possible. Jonathan Majors joins the adventure as Kang
               </p>
            </div>
            <ul class="movie-meta">
               <li><strong>Director:</strong>Peyton Reed</li>
               <li><strong>Length:</strong> 124 min</li>
               <li><strong>Premiere:</strong> 6, Feburary 2023 (USA)</li>
               <li><strong>Category:</strong> Phase 5</li>
            </ul>
