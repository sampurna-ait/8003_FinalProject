         ...
         <div class="col-md-6">
            <figure class="movie-poster">
               <div class="poster-wrapper">
                  <img src="posters/Movies/doctor2.jpg" alt="Doctor strange 2 Poster">
               </div>
            </figure>
         </div>
         <div class="col-md-6">
            <h2 class="movie-title">Doctor Strange in The Multiverse of Maddness</h2>
            <div class="movie-summary">
               <p>
                  Marvel Studios' "Doctor Strange in the Multiverse of Madness"—a thrilling ride through the Multiverse
                  with Doctor Strange, his trusted friend Wong and Wanda Maximoff,
                  aka Scarlet Witch. "Doctor Strange in the Multiverse of Madness" opens in U.S. theaters on May 6, 2022.
               </p>
            </div>
            <ul class="movie-meta">
               <li><strong>Director:</strong>Sam Raimi</li>
               <li><strong>Length:</strong> 126 min</li>
               <li><strong>Premiere:</strong> 6, May 2022 (USA)</li>
